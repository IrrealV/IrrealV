<div align="center">
  ...
  # Hola, soy Víctor Manuel Heras 👋
  ### Fullstack Developer & SysAdmin in training
  ...
  Estudiante de Ingeniería Telemática apasionado por la infraestructura, el backend y la optimización.
  Me encanta construir sistemas escalables con **NestJS**, automatizar con **Docker** y desplegar en **Azure**.
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Astro_5-BC52EE?style=for-the-badge&logo=astro&logoColor=white" />
...
| :--- | :--- | :--- |
| **[Portfolio](https://victorheras.me)** | `Astro 5` `Tailwind` | 🟢 Live |
| **[ScrumPoker Live](https://poker.victorheras.me)** | `Next.js` `NestJS` `WebSockets` | 🟢 Live |
| **[SuperPrompt](https://prompt.victorheras.me)** | `Astro` `Docker` `Azure` | 🟢 Live |
